...
export const CHARACTERS = [
  ...
  { name: "ハルト", gender: "m", build: 0, skin: SKIN.light, hair: HAIR.blond, style: "shaggy", eyes: EYES.blue, cloth: [200, 170, 90], note: "旅から来た若者" },
  ...
  { name: "カイト", gender: "m", build: 0, skin: SKIN.tan, hair: HAIR.red, style: "shaggy", eyes: EYES.green, beard: "stubble", cloth: [50, 120, 130], note: "陽気な力持ち" },
