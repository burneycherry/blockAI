  ...
  await new ActionFormData()
    ...
    .body(
      [
        ...
        "・農家: 作業設定でONにした作物を収穫する（小麦・ビートルート・ニンジン・ジャガイモ・カボチャ・スイカ・サトウキビ・竹・サボテン。初期は小麦だけ）。畑の作物は道具袋の種を使って植え直し、空いている畑には倉庫の種をまく（新しく耕すことはしないが、踏み荒らされた所は耕し直す）。落ちた作物や種は拾う。カボチャ・スイカは実だけ、サトウキビ・竹・サボテンは根元を残して刈る",
